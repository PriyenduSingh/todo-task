...
export default function TodoItem(){
    ...
    return (
       <div className="container my-5">
        <div className="mx-auto rounded border p-4" style={{width: "600px",  backgroundColor: "pink"}}>
           <h2 className="text-white text-center mb-5">Todo Task</h2>
           <form className="d-flex" onSubmit={handleSubmit}>
           <input className="form-control me-2" placeholder="Assign Task" name="task"/>
